function _G.init()
    ...
    cmake.setup({
        ...
        cmake_build_options = { "--parallel", "12", "-j12" }, -- this will be passed when invoke `CMakeBuild`
        ...
        cmake_kits_path = cmake_kits_path, -- this is used to specify global cmake kits path, see CMakeKits for detailed usage
